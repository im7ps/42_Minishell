...
int main() {
    char *args[] = {"echo", "test1", NULL};
    char *args2[] = {"echo", "test2", NULL};
    char *args3[] = {"echo", "test3", NULL};
...
// 			close(fd[i - 1][0]);
// 			ft_printf("Chiuso fd[%d][0]\n", i - 1);
// 			close(fd[i][1]);
// 			ft_printf("Chiuso fd[%d][1]\n", i);
// 			return (0);
// 		}
// 		else
// 		{
